...
async def handle_mcp_request(request: Request):
    ...
    try:
        ...
        # [심사 통과 포인트 1] 최신 프로토콜 버전 명시 (2024-11-05)
        # ----------------------------------------------------------------------
        if method == "initialize":
            return {
                ...
                "id": req_id,
                "result": {
                    "protocolVersion": "2024-11-05",  # PlayMCP 요구 사항 충족
                    "capabilities": {
                        "tools": {}
                    },
                    "serverInfo": {
        ...
        # ----------------------------------------------------------------------
        # 2. Notifications (initialized 등)
        # [심사 통과 포인트 2] Notification에는 JSON Body를 반환하지 않음 (200 OK만 전송)
        # 이 부분이 잘못되면 'Invalid JSON-RPC Response'로 반려됨
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        # 4. Tools List (Capability Discovery)
        # ----------------------------------------------------------------------
